...
#define SWIGTYPE_p_mjData swig_types[3]
#define SWIGTYPE_p_mjModel swig_types[4]
#define SWIGTYPE_p_mujoco__plugin__elasticity__WireStandalone swig_types[5]
...
SWIGINTERN PyObject *_wrap_WireStandalone_get_qfrc_passive_array(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "WireStandalone_get_qfrc_passive_array", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_mujoco__plugin__elasticity__WireStandalone, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
